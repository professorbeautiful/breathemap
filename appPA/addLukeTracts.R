...
#### Add the 56 tracts missing from pa_tracts, the join may pick up extra names.
...
pa_tracts_sw.luke_extended  $onlyLuke =
  ! (pa_tracts_sw.luke_extended$tracts %in% pa_tracts_sw.pre_luke$tracts)

table(pa_tracts_sw.luke_extended  $onlyLuke)   #56
