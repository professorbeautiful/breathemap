fluidPage({
  mainPanel(width = 12,
            ...
            tabsetPanel(
              tabPanel("Map Tool",
                fluidRow(
                  column(7, selectInput("town", "Select a town by clicking it or typing it in here: ", MAtownnames, selected = ""), 
              ...
              tabPanel("Comparison Tool",
                fluidRow(
                  column(6, selectInput("townleft", "Select a town to analyze: ", MAtownnames, selected = "Abington")),
                  column(6, selectInput("townright", "Select a town to compare against: ", MAtownnames, selected = "Acton"))),
                fluidRow(
